          ...
          <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
            ...
            <div className="w-full md:w-80">
              <input
                ...
                className="w-full px-4 py-2.5 text-sm rounded-lg border border-white/10 bg-white/5 text-cv-ink placeholder:text-cv-muted/50 focus:outline-none focus:ring-1 focus:ring-primary"
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-3 py-2 text-sm rounded-lg border border-white/10 bg-white/5 text-cv-ink focus:outline-none focus:ring-1 focus:ring-primary"
            ...
            <button
              ...
              className={`text-sm font-medium px-4 py-2 rounded-full border transition-colors ${
                selectedCategory === "All"
                  ...
                  : "border-white/10 bg-white/5 text-cv-muted hover:bg-white/10"
              }`}
              ...
              {filtered.map((guide) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-xs font-medium px-2 py-1 rounded border border-white/10 bg-white/5 text-cv-muted">
                      {guide.category}
                    </span>
                    {guide.featured && (
